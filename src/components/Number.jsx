    ...
    <>
      <div className="w-full h-screen flex items-center relative">
        ...
        <div className="w-128 h-144 absolute right-auto flex">
          ...
          <div className="flex absolute left-20 sm:left-0 top-44 w-44 h-44" ref={numberRef1}>
          ...
          <div className="flex absolute left-20 sm:left-0 bottom-0  w-44 h-44" ref={numberRef3}>
            <div className="font-abc tracking-wider">
