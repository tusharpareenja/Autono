    ...
    return (
        <>
            <div className='h-screen w-full mt-96 sm:mt-20 text-black flex items-center justify-center relative'>
                <div className='absolute sm:right-160 right-72'>
                    ...
                    <div className='flex items-center '>
                        <div className='mb-28 border border-solid border-black p-4 w-32 h-12 rounded-l-md text-center flex items-center justify-center hover:bg-black hover:text-white cursor-pointer'>
                            READ MORE
                        </div>
                        <div className='mb-28 border border-solid border-black w-14 h-12 flex items-center justify-center cursor-pointer rounded-r-md'>
